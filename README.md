...
### 记忆系统
*   **长期记忆体系**: 包含长期稳定的**核心记忆**、对话中沉淀的**情景记忆**，以及提炼个人画像的**记忆摘要**。
*   **会话记忆**: 支持仅在当前会话生效的局部记忆，用于记录临时设定、大纲或特定要求，不影响全局长期记忆。
*   **混合检索**: 支持关键词与向量混合检索，进一步提升查找历史细节的准确度。
*   **版本历史与对比**: 记录记忆摘要的历史版本，支持查看修改差异并可按需恢复旧版本。
*   **主动检索与管理**: 助手可在对话中主动检索记忆库与历史聊天记录；支持记忆置顶固定与暂停自动整合。
